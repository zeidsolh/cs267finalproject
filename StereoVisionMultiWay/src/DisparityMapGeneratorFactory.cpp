    ...
    const DisparityMapAlgorithmParameters_t &parameters)
{
    ...
    std::cout << "Creating disparity generator for " << parameters.algorithmName << "..." << std::endl;
